...
namespace ApiClients\Client\PetStore\Operation\Pets\List_;
...
final class Gatos
{
    ...
    private readonly Hydrator\Operation\Pets\Gatos $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Pets\Gatos $hydrator, int $perPage = 30, int $page = 1)
    {
